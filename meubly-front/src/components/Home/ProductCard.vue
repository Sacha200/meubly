...
<!-- ProductCard.vue -->
<template>
  <div class="bg-white dark:bg-gray-800 rounded-lg overflow-hidden border border-[#DBDBDB] dark:border-gray-600 w-full max-w-[280px] sm:w-72" style="border-radius: 10px;">
    <div class="relative">
      <img :src="product.cover_url" :alt="product.name" class="w-full h-48 sm:h-64 object-cover" />
      <div class="absolute top-2 right-2 flex flex-col space-y-2">
        <button
          class="bg-white dark:bg-gray-700 p-2 rounded-full shadow dark:shadow-gray-900/50 icon_favorite"
