    ...
    <div class="container mx-auto flex justify-between items-center p-4">
      ...
      <nav class="flex items-center">
        ...
        <div v-if="isConnected" class="relative mr-6">
          <button @click="toggleAdminMenu" class="flex items-center px-4 py-2 border border-primary-500 rounded-lg cursor-pointer transition-all duration-300 font-medium text-sm text-primary-500 hover:bg-primary-500 hover:text-white" :class="{ 'bg-primary-500 text-white': isAdminMenuOpen }">
          ...
          <!-- Dropdown Menu -->
          <div v-if="isAdminMenuOpen" class="absolute top-full right-0 mt-2 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-lg dark:shadow-gray-900/50 z-50 min-w-[220px] animate-fadeInDown">
            <div class="p-3">
              ...
              <router-link to="/admin/dashboard" class="flex items-center px-3 py-2.5 rounded-lg transition-all duration-200 text-gray-700 dark:text-gray-300 hover:bg-primary-500 hover:text-white hover:translate-x-1" @click="closeAdminMenu">
                <svg class="mr-2 w-4 h-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
