<template>
  <header class="bg-white dark:bg-gray-800 shadow-lg dark:shadow-gray-900/30 border-b border-gray-200 dark:border-gray-700">
    <div class="container mx-auto flex justify-between items-center p-4">
          ...
          <router-link to="/" class="text-lg title-font text-primary-500 dark:text-primary-400">Meubly</router-link>
        </div>
      <!-- Menu -->
      <div class="flex items-center">
        ...
        <a href="#" class="flex items-center link-favoris mr-8 text-gray-700 dark:text-gray-200 hover:text-primary-500 dark:hover:text-primary-400 transition-colors">
                      <svg class="mr-2 icon-favoris" @click="goToFavoris" width="25" height="22" viewBox="0 0 25 22" fill="none"
              xmlns="http://www.w3.org/2000/svg">
              <path
                d="M6.875 1.75C3.76888 1.75 1.25 4.07988 1.25 6.95438C1.25 9.2748 2.23437 14.782 11.924 
                ...
                4.90417 9.98112 1.75 6.875 1.75Z"
        ...
        <div v-if="isConnected" class="relative mr-6">
          <button @click="toggleAdminMenu" class="admin-menu-button flex items-center"
            ...
            Administration
            <svg class="ml-1 transition-transform" :class="{ 'rotate-180': isAdminMenuOpen }" width="16" height="16"
          ...
          <div v-if="isAdminMenuOpen" class="admin-dropdown">
            <div class="admin-dropdown-content">
              ...
              <router-link to="/admin/furnitures" class="admin-dropdown-item" @click="closeAdminMenu">
                <svg class="mr-2" width="16" height="16" viewBox="0 0 24 24" fill="none"
                  xmlns="http://www.w3.org/2000/svg">
                  <path d="M3 6H21L19 16H5L3 6Z" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path d="M3 6L2 2H1" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round" />
                </svg>
                Meubles
              </router-link>
        ...
        <div v-if="isConnected" class=" flex items-center">
          <span class="mr-2 connected-status">Connecté</span>
